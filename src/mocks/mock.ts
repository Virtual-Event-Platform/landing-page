...
export const eventText = "Notre plateforme offre une solution innovante pour les organisateurs d'évènemenets cherchant à créer des évènements virtuels interactifs et captivants";
